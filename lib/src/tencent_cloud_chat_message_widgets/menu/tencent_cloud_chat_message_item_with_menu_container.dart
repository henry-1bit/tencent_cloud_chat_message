...
import 'package:tencent_cloud_chat_message/src/tencent_cloud_chat_message_input/forward/tencent_cloud_chat_message_forward_container.dart';
...
class _TencentCloudChatMessageItemWithMenuContainerState
  ...
  final Stream<TencentCloudChatMessageData<dynamic>>? _messageDataStream = TencentCloudChat.instance.eventBusInstance
      .on<TencentCloudChatMessageData>('TencentCloudChatMessageData');
  ...
  final String _appPackage = 'tencent_cloud_chat_message';
  ...
  void _messageDataHandler(TencentCloudChatMessageData messageData) {
    ...
    final messageDataKeys = messageData.currentUpdatedFields as TencentCloudChatMessageDataKeys;
    ...
    switch (messageDataKeys) {
      ...
      case TencentCloudChatMessageDataKeys.sendMessageProgress:
        ...
        } else if (TencentCloudChatUtils.checkString(_message.id) != null &&
            _message.id != msgID &&
  ...
  List<TencentCloudChatMessageGeneralOptionItem> _generateMenuOptions({
    ...
    final useReadReceipt =
        defaultMessageMenuConfig.enableGroupMessageReceipt &&
    ...
    final defaultMenuOptions = [
      if (defaultMessageMenuConfig.enableMessageCopy)
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/copy_message.png', package: _appPackage),
          label: tL10n.copy,
      ...
      if (defaultMessageMenuConfig.enableMessageForward && _message.status == MessageStatus.V2TIM_MSG_STATUS_SEND_SUCC)
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/forward_message.png', package: _appPackage),
          label: tL10n.forward,
            ...
            if (isDesktopScreen) {
              TencentCloudChatDesktopPopup.showPopupWindow(
                ...
                child: (closeFunc) => TencentCloudChatMessageForwardContainer(
                  ...
                  context: context,
                  messages: [_message],
                  messageForwardBuilder: TencentCloudChatMessageDataProviderInherited.of(
                    context,
                  ).messageBuilders?.getMessageForwardBuilder,
                ),
              );
            } else {
      ...
      if (_showRecallButton())
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/revoke_message.png', package: _appPackage),
          label: tL10n.recall,
      ...
      if (defaultMessageMenuConfig.enableMessageQuote && _message.status == MessageStatus.V2TIM_MSG_STATUS_SEND_SUCC)
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/quote_message.png', package: _appPackage),
          id: '_uikit_quote_message',
          label:
          config.enableQuoteWithMention(
            userID: dataProvider.userID,
            topicID: dataProvider.topicID,
            groupID: dataProvider.groupID,
          )
      ...
      if (defaultMessageMenuConfig.enableMessageSelect)
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/multi_message.svg', package: _appPackage),
      ...
      if (enableMessageDeleteForSelf)
        TencentCloudChatMessageGeneralOptionItem(
          iconAsset: (path: 'assets/icons/delete_message.png', package: _appPackage),
          label: tL10n.delete,
